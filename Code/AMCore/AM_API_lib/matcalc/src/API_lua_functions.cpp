...
#pragma region Calculations
	...
	add_new_function(state, "pixelcase_calculate_heat_treatment", "std::string out", "pixelcase_calculate_heat_treatment", Bind_SPC_parallel_calculate_heat_treatment);
#pragma endregion
