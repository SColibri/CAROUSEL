...
database_table_custom_query("CREATE VIEW IF NOT EXISTS v_grouped_heat_treatment_simulation AS "..
...
database_table_custom_query("CREATE VIEW IF NOT EXISTS v_last_heat_treatment_simulation AS "..
...
database_table_custom_query("CREATE VIEW IF NOT EXISTS vd_HeatTreatment_Plot AS "..
...
database_table_custom_query("CREATE VIEW IF NOT EXISTS vd_SelectedElements AS"..
    "SELECT "..
...
database_table_custom_query("CREATE VIEW IF NOT EXISTS vd_ElementComposition AS"..
"SELECT "..
